...
MESSAGE_TEMPLATES: dict[str, dict] = {
    ...
    "account_setup": {
        ...
        "description": (
            ...
            "**⚠️ Avant chaque publication**\n"
            "Envoie **TOUTES** tes vidéos dans "
            + channel_mention("approval")
            + " **avant** de les poster. C’est aussi là que tu enverras tes "
            "captures du temps d’écran et ton enregistrement d’écran du **FYP** "
            "(TikTok) / de la page **Explore** (Instagram).\n\n"
            "**Fréquence de posts :**\n\n"
